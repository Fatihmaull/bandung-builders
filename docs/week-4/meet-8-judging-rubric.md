...
| Score | Anchor                                                                                                                                    |
| ----- | ----------------------------------------------------------------------------------------------------------------------------------------- |
| 10    | Contract is deployed, verified on Basescan, fully tested with `forge test`. Demo flows work first try. Code shows mastery (gas, errors, modifiers correctly placed). |
...
| 4     | Contract not deployed to Base Sepolia; only local. Demo via anvil/screenshot. Recognizable Solidity but with obvious bugs.                 |
...
- ☐ Contract deployed to Base Sepolia? (Block: address visible on Basescan.)
- ☐ Contract **verified** on Basescan? (Read tab works.)
...
| 2     | UI exists but the demo had to be conducted via cast / Basescan to actually function.                                                                    |
| 0     | No UI presented.                                                                                                                                        |
...
- ☐ User can find the contract on Basescan from the UI in ≤ 2 clicks.
