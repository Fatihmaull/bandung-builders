...
| Score | Anchor                                                                                                                                    |
| ----- | ----------------------------------------------------------------------------------------------------------------------------------------- |
| 10    | Contract is deployed, verified on Arbiscan, fully tested with `forge test`. Demo flows work first try. Code shows mastery (gas, errors, modifiers correctly placed). |
...
| 4     | Contract not deployed to Arbitrum Sepolia; only local. Demo via anvil/screenshot. Recognizable Solidity but with obvious bugs.                 |
...
- ☐ Contract deployed to Arbitrum Sepolia? (Block: address visible on Arbiscan.)
- ☐ Contract **verified** on Arbiscan? (Read tab works.)
...
| 2     | UI exists but the demo had to be conducted via cast / Arbiscan to actually function.                                                                    |
| 0     | No UI presented.                                                                                                                                        |
...
- ☐ User can find the contract on Arbiscan from the UI in ≤ 2 clicks.
