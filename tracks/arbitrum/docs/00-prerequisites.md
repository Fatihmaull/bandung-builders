...
- 10 GB free disk.
- Stable internet — Arbitrum Sepolia RPCs can be flaky from low-bandwidth links.
...
- [Arbiscan](https://basescan.org/myapikey) — free API key for contract verification.
- [WalletConnect Cloud](https://cloud.walletconnect.com) — free `projectId` for RainbowKit.
- [Coinbase Faucet](https://ethfaucet.com/) — for Arbitrum Sepolia ETH.
...
## 4. Get a Arbitrum Sepolia wallet + funds
...
4. Visit <https://ethfaucet.com/>, sign in with a Coinbase account, request 0.05 Arbitrum Sepolia ETH. You'll need to repeat this every ~24 hours throughout the workshop.
...
Verify by asking the agent: *"What network are we targeting and what is the precision factor in the reward math?"* — it should answer "Arbitrum Sepolia (chainId 421614)" and "`1e18`".
...
- [ ] Have a Arbitrum Sepolia address with > 0 ETH.
