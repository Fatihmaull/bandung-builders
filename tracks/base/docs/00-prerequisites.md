...
For testnet ETH (no mainnet activity required):

- [ethfaucet.com](https://ethfaucet.com/) — recommended Base Sepolia faucet.
...
4. Visit <https://ethfaucet.com/>, select **Base Sepolia**, paste your wallet address, and claim testnet ETH. Repeat every 24 hours as needed.

---

## 5. Verify your AI agent

The repo ships with [`/.cursorrules`](../../../.cursorrules) at the monorepo root (multi-track). If you use:
