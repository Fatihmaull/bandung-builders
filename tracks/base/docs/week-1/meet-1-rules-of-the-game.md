# Rules of the Game — Bandung Base Builders Cohort
...
Base Sepolia only. No mainnet RPC URLs in `.env`. No mainnet private keys. If you accidentally fund a mainnet address with workshop ETH, treat that ETH as gone — do not "just deploy a quick fix to mainnet to recover it." That is how exploits ship.
...
- [ ] Your contract is deployed *and verified* on Base Sepolia.
...
I, ___________________________________________, agree to the five rules above for the duration of the Bandung Base Builders cohort.
