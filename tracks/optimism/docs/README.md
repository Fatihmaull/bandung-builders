# Curriculum — Bandung OP Builders

A 4-week, 8-session intensive workshop teaching tech-savvy developers in Bandung to ship a hackathon-ready DeFi Staking Protocol MVP on OP Sepolia.
...
- **Final deliverable:** a deployed, verified contract on OP Sepolia + a connected Next.js dApp + a 5-minute pitch
...
- [`../../guide.md`](../../guide.md) — **Facilitator guide** (pre-session checklist, URLs, agent setup).
...
| File                                                                                 | Type            | Purpose                                                |
| ------------------------------------------------------------------------------------ | --------------- | ------------------------------------------------------ |
| [`week-1/meet-1-kickoff-evm-narrative.md`](./week-1/meet-1-kickoff-evm-narrative.md) | Speaker script  | EVM internals, OP Stack L2 rollup mechanics, Bandung vision |
...
| [`week-2/meet-3-presenter-script.md`](./week-2/meet-3-presenter-script.md)         | Presenter script | **Script menit-per-menit ~160 min** Meet 3 ideation     |
| [`week-2/meet-3-web3-sectors.md`](./week-2/meet-3-web3-sectors.md)                 | Reference       | Web3 sector map (DeFi, RWA, consumer, GameFi, SocialFi…) |
...
| [`week-4/meet-7-gtm-base.md`](./week-4/meet-7-gtm-base.md)                           | Framework       | Go-to-market for low-gas consumer dApps on OP Sepolia          |
| [`week-4/meet-8-judging-rubric.md`](./week-4/meet-8-judging-rubric.md)               | Scoring rubric  | Weighted criteria for Demo Day                           |
| [`week-4/meet-8-deployment-checklist.md`](./week-4/meet-8-deployment-checklist.md)   | Checklist       | OP Sepolia Etherscan verify + Vercel deploy walkthrough              |
