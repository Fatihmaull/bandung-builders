...
- 10 GB free disk.
- Stable internet — OP Sepolia RPCs can be flaky from low-bandwidth links.
...
- [OP Sepolia Etherscan](https://basescan.org/myapikey) — free API key for contract verification.
- [WalletConnect Cloud](https://cloud.walletconnect.com) — free `projectId` for RainbowKit.
- [Coinbase Faucet](https://console.optimism.io/faucet) — for OP Sepolia ETH.
...
## 4. Get a OP Sepolia wallet + funds
...
4. Visit <https://console.optimism.io/faucet>, sign in with a Coinbase account, request 0.05 OP Sepolia ETH. You'll need to repeat this every ~24 hours throughout the workshop.
...
Verify by asking the agent: *"What network are we targeting and what is the precision factor in the reward math?"* — it should answer "OP Sepolia (chainId 11155420)" and "`1e18`".
...
- [ ] Have a OP Sepolia address with > 0 ETH.
- [ ] OP Sepolia Etherscan API key obtained.
