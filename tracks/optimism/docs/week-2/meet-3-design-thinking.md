...
- **Web3 twist:** *test on testnet*. Get 3–5 humans through your dApp on OP Sepolia before Demo Day. Watch them. Note where they get stuck. Time how long it takes them to do one transaction. This is more valuable than any code review.
